# Contributing to ayanami-nemesis-analyzer

The ayanami-nemesis-analyzer team encourages community feedback and contributions.
Thank you for your interest in making ayanami-nemesis-analyzer better! There are several
ways you can get involved.

If you are looking for a good way to contribute to the project, please:

* have a look at the [available issue templates](https://github.com/filipdutescu/ayanami-nemesis-analyzer/issues/new/choose)
and checkout the [examples of good first issues](https://github.com/filipdutescu/ayanami-nemesis-analyzer/contribute)
(or [click here](https://github.com/filipdutescu/ayanami-nemesis-analyzer/labels/good%20first%20issue)).

* look through the [issues that need help](https://github.com/filipdutescu/ayanami-nemesis-analyzer/labels/help%20wanted).
...
the [Bug Report template](https://github.com/filipdutescu/ayanami-nemesis-analyzer/issues/new?assignees=&labels=bug&template=bug_report.md&title=[BUG]).
Should the template provided not suit your needs, feel free to make a
[custom Bug Report](https://github.com/filipdutescu/ayanami-nemesis-analyzer/issues/new/choose),
but please label it accordingly.

We are happy to hear your ideas for how to further improve ayanami-nemesis-analyzer,
ensuring it suits your needs. Check the [Issues](https://github.com/filipdutescu/ayanami-nemesis-analyzer/issues)
and see if others have submitted similar feedback. You can upvote existing feedback
(using the thumbs up reaction/by commenting) or [submit a new suggestion](https://github.com/filipdutescu/ayanami-nemesis-analyzer/labels/feature).

We always look at upvoted items in [Issues](https://github.com/filipdutescu/ayanami-nemesis-analyzer/issues)
...
Issues marked [`good first issue`](https://github.com/filipdutescu/ayanami-nemesis-analyzer/labels/good%20first%20issue)
are a good place to start.

You can also check the [`help wanted`](https://github.com/filipdutescu/ayanami-nemesis-analyzer/labels/help%20wanted)
...
from reviewers. Try looking at [past pull requests](https://github.com/filipdutescu/ayanami-nemesis-analyzer/pulls?q=is%3Apr+is%3Aclosed)
